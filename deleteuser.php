...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if($stmt = $pdo->prepare($sql)){
        ...
        if($stmt->execute()){
            ...
            echo '<script>alert("Oops! Something went wrong. Please try again later.");window.open("userlist.php","_self");</script>';
        }
    }
    ...
    if(empty(trim($_GET["id"]))){
        ...
        echo '<script>alert("Invalid Request.");window.open("userlist.php","_self");</script>';
        exit();
    }
}
?>
                    ...
                    <div class="card-body">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <div class="flex">
                                ...
                                <a href="userlist.php" class="btn btn-primary">No</a>
                            </div>
                        </form>
                    </div>
                </div>
